...
// adminDistEventbrokerUnfsdBinUnfsd reads file data from disk. It returns an error on failure.
func adminDistEventbrokerUnfsdBinUnfsd() (*asset, error) {
	path := filepath.Join(rootDir, "admin/dist/eventbroker/unfsd/bin/unfsd")
	name := "admin/dist/eventbroker/unfsd/bin/unfsd"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// adminDistEventbrokerUnfsdEtcExports reads file data from disk. It returns an error on failure.
func adminDistEventbrokerUnfsdEtcExports() (*asset, error) {
	path := filepath.Join(rootDir, "admin/dist/eventbroker/unfsd/etc/exports")
	name := "admin/dist/eventbroker/unfsd/etc/exports"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// adminDistEventbrokerUnfsdEtcExportsJson reads file data from disk. It returns an error on failure.
		...
		"dist": &bintree{nil, map[string]*bintree{
			...
			"eventbroker": &bintree{nil, map[string]*bintree{
				...
				"unfsd": &bintree{nil, map[string]*bintree{
					"bin": &bintree{nil, map[string]*bintree{
						"unfsd": &bintree{adminDistEventbrokerUnfsdBinUnfsd, map[string]*bintree{}},
					}},
					"etc": &bintree{nil, map[string]*bintree{
