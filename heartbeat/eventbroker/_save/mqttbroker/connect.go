...
//func (me *MqttBroker) IsConnected() (bool, error) {
//
//	var err error
//	var ok bool
//
...
//
//
//func (me *MqttBroker) ConnectToServer(u string) error {
//
//	var err error
//	var ok bool
//
...
//				eblog.Debug(me.EntityId, "MqttBroker already connected to broker %s", me.Server.String())
//				break
//			}
//
//			eblog.Debug(me.EntityId, "MqttBroker disconnecting from broker %s", me.Server.String())
...
//		eblog.Debug(me.EntityId, "MqttBroker setting LWaT as '%s' on %s", myWill, me.Server.String())
//
...
//
//
//func (me *MqttBroker) GlobSubscribe(client messages.MessageAddress) error {
//
//	var err error
//	var ok bool
//
